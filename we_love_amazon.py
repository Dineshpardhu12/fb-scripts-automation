...
def main():
    ...
    PAGE_ID = '1198164120277701'  # Your Facebook Page ID
    ACCESS_TOKEN = 'EAAOTnfd8lAEBOZBptoZAXlnMnFFUfEkh4FZBdo9m1HD967wR5FMPoC8ZBSY1kgyfklbwbhJh8wpfiydDCyVPbpKX4WmRZB8uV5JLfkccfO3LTZBNfv7nVMThAUzawcn7YOsty9lwVnDsoFYK4E6j88e7uTwucy4a38co9qHrKSXT9dR9ARav3HA5mG4juYBPnj'  # Your access token
    EXCEL_FILE_PATH = '/app/fb.xlsx'  # Path to your Excel file
    MAX_RETRIES = 5  # Maximum number of retries for product extraction
